    ...
    <div className="flex h-full min-h-[280px] flex-col rounded-[2rem] border border-[color-mix(in_srgb,var(--ds-border)_50%,transparent)] bg-[color-mix(in_srgb,white_88%,var(--ds-background))] p-5 shadow-[var(--ds-shadow-soft)] backdrop-blur-xl">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <input
          ...
          className="min-w-[200px] flex-1 rounded-full border border-[color-mix(in_srgb,var(--ds-border)_70%,transparent)] bg-white/90 px-5 py-2.5 font-body text-sm outline-none focus-visible:ring-2 focus-visible:ring-[var(--ds-primary)]"
        />
      </div>
