...
| 个性化日记推荐 | `/api/v1/diaries/recommend` | GET | Diary/Recommend | 是 | 是 | 已可用 | `DiaryRecommendQuery` | `PageResultVO<DiaryVO>` | `DiaryController.java`、`DiaryRecommendServiceImpl.java` | `api-spec.md` 13.2A、`SecurityConfig.java` | 需要 JWT；兴趣/热度/评分 Top-K；无偏好时降级为热度 |
