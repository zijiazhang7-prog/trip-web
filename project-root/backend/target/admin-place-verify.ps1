...
try {
    ...
    $updatedName = "Admin场所实库验证已修改$stamp"
    ...
    $protected = Invoke-Api Post "$base/admin/places" $adminHeaders (@{ destinationId = $destinationId; name = "Admin场所设施引用保护$stamp"; placeType = 'building'; description = 'facility reference protected' } | ConvertTo-Json -Compress)
    ...
    $facility = Invoke-Api Post "$base/admin/facilities" $adminHeaders (@{ destinationId = $destinationId; placeId = $protectedPlaceId; name = "Admin场所引用设施$stamp"; facilityType = 'toilet'; description = 'reference test' } | ConvertTo-Json -Compress)
    ...
    $nodeProtected = Invoke-Api Post "$base/admin/places" $adminHeaders (@{ destinationId = $destinationId; name = "Admin场所节点引用保护$stamp"; placeType = 'building'; description = 'map node reference protected' } | ConvertTo-Json -Compress)
    ...
    $node = Invoke-Api Post "$base/admin/map/nodes" $adminHeaders (@{ destinationId = $destinationId; nodeName = "Admin场所引用节点$stamp"; nodeType = 'place'; refId = $nodeProtectedPlaceId; lng = 116.333333; lat = 39.333333; floorNo = 1 } | ConvertTo-Json -Compress)
