...
public class NearbyFacilityVO {
    ...
    public static NearbyFacilityVO from(
            Facility facility,
            BigDecimal reachableDistance,
            Long sourceNodeId,
            Long targetNodeId) {
        ...
        vo.setSourceNodeId(sourceNodeId);
        vo.setTargetNodeId(targetNodeId);
        return vo;
    }
    ...
    public BigDecimal getReachableDistance() {
        return reachableDistance;
    }

    public void setReachableDistance(BigDecimal reachableDistance) {
